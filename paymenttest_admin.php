...
{
?>
<form action="savepayment.php?room_id=<?php echo $objResult["room_id"];?>" name="frmEdit" method="post">
  <tr>
    ...
    <option value="0" <?php if($objResult['room_bill']== 0){ ?> selected <?php } ?> > ยังไม่ได้ชำระ	 </option>
    <option value="1" <?php if($objResult['room_bill']== 1){ ?> selected <?php } ?>> ชำระแล้ว</option>
