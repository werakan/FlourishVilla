...
INNER JOIN rent
ON customer.cus_id = rent.cus_id
INNER JOIN room
ON rent.rent_id = room.room_id
INNER JOIN room_type
ON room.room_type = room_type.roomtype_id
";
...
?>
  ...
  <tr>
    <th width="238"> <div align="center">เลขห้อง </div></th>
    <th width="260"> <div align="center">Name </div></th>
    <th width="256"> <div align="center">lasname </div></th>
    <th width="358"> <div align="center">ประเภทห้อง</div></th>
...
?>
  <tr>
    ...
    <td><?php echo $objResult["roomtype_name"];?></td>
